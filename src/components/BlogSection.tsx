    ...
    <section className="py-24 px-6 md:px-12 lg:px-24 bg-white">
      <div className="container mx-auto">
        ...
        {mockPosts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center border border-slate-100 rounded-[3rem] bg-slate-50/50">
            <h3 className="text-2xl font-display font-black text-slate-800 mb-2">Insights Coming Soon</h3>
            <p className="text-slate-500 font-medium max-w-sm">We're preparing new structured case studies and articles. Stay tuned.</p>
          </div>
        )}
      </div>
    </section>
